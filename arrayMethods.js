...
const myStrongest = monstersInYourPocket.filter(points => points.CP > 200)
...
const sumPurchases = purchases.filter(i => i.owner === "Bob").reduce((acc, purchases) => acc + purchases.price, 0)
